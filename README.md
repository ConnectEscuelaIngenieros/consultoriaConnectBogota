...
Lee estructura jerárquica: CAPÍTULO → SUBCAPÍTULO → ÍTEM → INSUMO
Extrae fecha de referencia de la fila 4 del Excel
Aplica IPC fijo (Febrero 2023: 130.40 → Septiembre 2025: 151.48)
Calcula VP para:
...
VP-AJUSTADO.R - VERSIÓN FINAL (RECOMENDADA)
...
Carga IPC históricos y limpia fechas seriales de Excel
Lee tabla Looker con información de proyectos, ítems e insumos
Extrae fecha de elaboración de cada registro y hace matching automático con IPC correspondiente
Calcula valor presente para 4 columnas monetarias:
...
Aplica fórmula: VP = Valor Original × (IPC Sep-2025 / IPC Histórico)
